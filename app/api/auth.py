...
# You need to import or define User and create_access_token somewhere above this file
...
async def register(payload: RegisterReq):
	...
	user = User(username=payload.username, is_anonymous=payload.anonymous, hashed_password=hashed_password)
	await user.insert()
